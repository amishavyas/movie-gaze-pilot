    ...
    return (
        <Container component="main" maxWidth="md" align="center">
            ...
            <Typography component="h2" variant="h6">
                ...
                <br />
                <i>Study title</i>: Behavioral studies of social
                interaction
                <br />
                <i>Principal Investigator</i>: Meghan Meyer
                <br />
                <br />
            ...
            <StyledButton handleClick={nextPage} text="Begin Study" buttonColor="#e4d09e" />
        </Container>
    );
};
